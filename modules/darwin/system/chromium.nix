# The managed-policy half of Chromium (mirrors modules/nixos/chromium.nix's
# JSON). /Library/Managed Preferences is root-owned, so this stays a system
# activation script even though the app itself (home/darwin/chromium.nix) is
...
let
  policy = import (selfPath "home/common/chromium/policy.nix");
