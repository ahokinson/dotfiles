...
in
{
  ...
  # swayidle, xwayland) - home/linux/sway already covers each: ghostty is
  ...
  # brightnessctl (home/linux/sway/compositor.nix's XF86MonBrightness binds)
  ...
  # (home/linux/sway/osd.nix) ships its own udev rule for the same reason.
