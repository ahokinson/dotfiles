{ pkgs, lib, ... }: {
  ...
  # Old generations otherwise stack up indefinitely across switches/reboots
  # (see boot.loader.systemd-boot.configurationLimit in boot.nix for the
  # boot-menu side of this).
  nix.gc = {
    automatic = true;
    dates = "weekly";
