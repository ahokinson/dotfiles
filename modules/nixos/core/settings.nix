...
}:
{
  ...
  config = {
    ...
    # shadows the nix-index handler from home/common/infrastructure/nix/nix-index.nix.
    ...
    # home/linux/desktop/integration/applications.nix's NoDisplay shadow can't reach it the way
    # modules/nixos/services/printing.nix's cups override does. This is the only lever.
