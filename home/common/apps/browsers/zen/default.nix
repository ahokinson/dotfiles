...
let
  activation = import (selfPath "home/common/apps/browsers/zen/activation.nix") {
    inherit pkgs config;
  };
  userJs = import (selfPath "home/common/apps/browsers/zen/prefs.nix") { inherit pkgs lib selfPath; };
  theme = import (selfPath "home/common/apps/browsers/zen/theme.nix") { inherit inputs pkgs; };
  chrome = import (selfPath "home/common/apps/browsers/zen/chrome.nix") { inherit pkgs; };
in
{
  ...
  imports = [ (selfPath "home/common/apps/browsers/zen/extensions.nix") ];
