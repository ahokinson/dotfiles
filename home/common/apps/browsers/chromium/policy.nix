...
# modules/nixos/programs/chromium.nix (-> JSON under /etc/chromium/policies/managed/)
...
# here must be valid, and mean the same thing, on both platforms.
{
  ...
  # --- Autofill / passwords ---------------------------------------------
  # Mirrors home/common/apps/browsers/zen/data.nix's formautofill.{addresses,creditCards}
