# Shared by modules/nixos/services/open-webui.nix and home/darwin/open-webui.nix.
...
pkgs.writeText "open-webui-custom.css" ''
  /* Catppuccin Mocha for Open WebUI - generated from home/common/theme/palette.nix.
     See home/common/apps/ai/open-webui/theme.nix for how and why. */
