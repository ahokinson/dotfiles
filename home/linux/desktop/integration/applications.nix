...
# nixos-manual both had one; modules/nixos/services/printing.nix strips the former at
# the source instead, and modules/nixos/core/settings.nix drops the latter
...
_: {
  xdg.desktopEntries = {
    ...
    # programs.yazi (home/common/terminal/yazi.nix) installs it; pkgs.yazi ships a
