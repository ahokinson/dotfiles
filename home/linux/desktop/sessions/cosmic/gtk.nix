...
# from home/linux/desktop/theme/catppuccin.nix's icon and cursor theming because everything
...
let
  ...
  # home/linux/desktop/sessions/cosmic/theme.nix), because the daemon owning gtk.css means
...
in
{
  ...
  # Mirrors home/linux/desktop/theme/catppuccin.nix's cursor theme into GTK.
