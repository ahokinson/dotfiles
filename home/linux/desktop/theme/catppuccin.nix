...
# permitted module import live in home/common/theme/catppuccin.nix.
{ pkgs, ... }:
{
  catppuccin = {
    autoEnable = false;
    ...
    # home/common/theme/catppuccin.nix) and none exist on darwin, so they opt in
    ...
    # namespace. GTK colors come from home/linux/desktop/sessions/cosmic/gtk.nix's WhiteSur
    # theme, so leave the Catppuccin icon variant disabled.
    gtk.icon.enable = false;
  };

  # Cursor assets only. The icon theme comes from home/linux/desktop/icons.
