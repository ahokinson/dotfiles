...
# rest is in hosts/nixos/raspberry-pi/common.nix.
...
# is disabled (modules/nixos/networking/ssh.nix) and anders isn't a trusted Nix user,
...
{ config, selfPath, ... }:
{
  ...
  imports = [ (selfPath "hosts/nixos/raspberry-pi/common.nix") ];
  ...
  # supported path. modules/nixos/services/containers.nix (imported via
  ...
  virtualisation.oci-containers.containers.pihole = {
    ...
    # embedded resolver (aardvark-dns, from modules/nixos/services/containers.nix's
