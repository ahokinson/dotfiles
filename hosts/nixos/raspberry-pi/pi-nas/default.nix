...
# host is for; the rest is in hosts/nixos/raspberry-pi/common.nix.
...
}:
{
  ...
  imports = [
    ...
    (selfPath "hosts/nixos/raspberry-pi/pi-nas/disko-config.nix")
    (selfPath "hosts/nixos/raspberry-pi/common.nix")
  ];
